(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__56ded1b7._.js", {
...
function RootLayout({ children }) {
    _s();
    // Suprime erros de hidratação causados por extensões de navegador
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RootLayout.useEffect": ()=>{
            // Este efeito só é executado no cliente
            const originalError = console.error;
            console.error = ({
                "RootLayout.useEffect": (...args)=>{
                    if (typeof args[0] === 'string' && args[0].includes('Warning: Text content did not match') || args[0].includes('Warning: Prop') && args[0].includes('did not match') || args[0].includes('A tree hydrated but some attributes')) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__56ded1b7._.js.map